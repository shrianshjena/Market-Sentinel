        ...
        {showTooltip && (
          ...
          >
            ...
            <ul className="text-xs text-white/60 space-y-1.5">
              <li className="flex justify-between"><span>Price Trend:</span> <span className="text-white">20%</span></li>
              <li className="flex justify-between"><span>Fundamental Value:</span> <span className="text-white">20%</span></li>
              <li className="flex justify-between"><span>Sentiment Logic:</span> <span className="text-white">20%</span></li>
